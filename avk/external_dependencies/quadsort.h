...
void tail_swap32(void *array, unsigned char nmemb, CMPFUNC *cmp)
{
	int pts[8];
	register int *pta = (int*)array;
...
void tail_merge32(void *array, int *swap, unsigned int nmemb, unsigned int block, CMPFUNC *cmp);

unsigned int quad_swap32(void *array, unsigned int nmemb, CMPFUNC *cmp)
{
	int swap[16];
	unsigned int offset;
...
void quad_merge32(void *array, int *swap, unsigned int nmemb, unsigned int block, CMPFUNC *cmp)
{
	unsigned int offset;
	...
	while (block * 8 < nmemb)
	{
		...
		tail_merge32((int*)array + offset, swap, nmemb - offset, block, cmp);
...
void tail_swap64(void *array, unsigned char nmemb, CMPFUNC *cmp)
{
	long long pts[8];
	register long long *pta = (long long*)array;
	register unsigned char i, mid, cnt;
...
void tail_merge64(void *array, long long *swap, size_t nmemb, size_t block, CMPFUNC *cmp);

size_t quad_swap64(void *array, size_t nmemb, CMPFUNC *cmp)
{
	long long swap[16];
	size_t offset;
	...
	pta = pte = (long long*)array + offset;
...
void quad_merge64(void *array, long long *swap, size_t nmemb, size_t block, CMPFUNC *cmp)
{
	size_t offset;
	...
	while (block * 8 < nmemb)
	{
		...
		tail_merge64((long long*)array + offset, swap, nmemb - offset, block, cmp);
